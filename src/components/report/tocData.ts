...
export const TOC_ENTRIES: TocEntry[] = [
  ...
  { label: '4. Requirements', indent: 0 },
  { label: '5. Locations & Justification for Probe / Data Loggers', key: 'layoutPositions' },
  { label: '6. Procedures', indent: 0 },
  { label: '7. Acceptance Criteria', indent: 0 },
  { label: '8. Revalidation Frequency', indent: 0 },
  { label: '9. Result & Evaluation', indent: 0 },
  { label: '10. Summary & Conclusion', indent: 0 },
  { label: '11. Deviation', indent: 0 },
  { label: '12. References', indent: 0 },
